...
_Generated: 2026-07-14T12:43:17.653Z_
...
Workspace `mcp.json` _(folder: NexaStudy)_

- **c:\Users\pc\Desktop\NexaStudy\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\pc\.claude.json** — _File exists — no servers defined_
