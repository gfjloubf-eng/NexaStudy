...
import { LessonViewerPage } from '../features/course/LessonViewerPage'
...
export const router = createBrowserRouter([
  ...
  },
  {
    path: 'course/:id',
    element: <AuthGuard />,
    children: [{ index: true, element: <CourseDetailsPage /> }],
  },
  {
    path: 'course/:id/lesson/:lessonId',
    element: <AuthGuard />,
    children: [{ index: true, element: <LessonViewerPage /> }],
  },
  {
    path: '*',
